...
<section class="social" id="social" aria-label="Latest from our channels">
  ...
  <div class="wrap">
    <div class="sec-head">
      ...
      <p>The latest from our YouTube channel — real activities, real people, this week. <span class="chip chip--sample">Real Shorts thumbnails — in production the live feed keeps these updated to the 4 newest automatically</span></p>
    </div>
    <div class="social-grid" data-feed="youtube-latest-4">
      <a class="stile" href="https://www.youtube.com/@fitcaresupportservices">
        <div class="media media--short"><img class="media-img" src="@/assets/img/yt/short-1.jpg" alt="FITCare Short: a support worker holds a soccer ball mid-chat in the gym"><span class="play-badge"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg></span></div>
        <span class="stile-cap"><svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M23 7.5s-.2-1.6-.9-2.3c-.9-.9-1.9-.9-2.4-1C16.4 4 12 4 12 4s-4.4 0-7.7.2c-.5.1-1.5.1-2.4 1-.7.7-.9 2.3-.9 2.3S1 9.4 1 11.3v1.4c0 1.9.2 3.8.2 3.8s.2 1.6.9 2.3c.9.9 2 .9 2.5 1 1.8.2 7.4.2 7.4.2s4.4 0 7.7-.3c.5-.1 1.5-.1 2.4-1 .7-.7.9-2.3.9-2.3s.2-1.9.2-3.7v-1.4c0-1.9-.2-3.8-.2-3.8z"/></svg>Watch this Short →</span>
      </a>
      <a class="stile" href="https://www.youtube.com/@fitcaresupportservices">
        <div class="media media--short"><img class="media-img" src="@/assets/img/yt/short-2.jpg" alt="FITCare Short: a participant trains on a gym machine — 'Nutritious meal in 2'"><span class="play-badge"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg></span></div>
        <span class="stile-cap"><svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M23 7.5s-.2-1.6-.9-2.3c-.9-.9-1.9-.9-2.4-1C16.4 4 12 4 12 4s-4.4 0-7.7.2c-.5.1-1.5.1-2.4 1-.7.7-.9 2.3-.9 2.3S1 9.4 1 11.3v1.4c0 1.9.2 3.8.2 3.8s.2 1.6.9 2.3c.9.9 2 .9 2.5 1 1.8.2 7.4.2 7.4.2s4.4 0 7.7-.3c.5-.1 1.5-.1 2.4-1 .7-.7.9-2.3.9-2.3s.2-1.9.2-3.7v-1.4c0-1.9-.2-3.8-.2-3.8z"/></svg>Watch this Short →</span>
      </a>
      <a class="stile" href="https://www.youtube.com/@fitcaresupportservices">
        <div class="media media--short"><img class="media-img" src="@/assets/img/yt/short-3.jpg" alt="FITCare Short: close-up of an archer drawing a bow"><span class="play-badge"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg></span></div>
        <span class="stile-cap"><svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M23 7.5s-.2-1.6-.9-2.3c-.9-.9-1.9-.9-2.4-1C16.4 4 12 4 12 4s-4.4 0-7.7.2c-.5.1-1.5.1-2.4 1-.7.7-.9 2.3-.9 2.3S1 9.4 1 11.3v1.4c0 1.9.2 3.8.2 3.8s.2 1.6.9 2.3c.9.9 2 .9 2.5 1 1.8.2 7.4.2 7.4.2s4.4 0 7.7-.3c.5-.1 1.5-.1 2.4-1 .7-.7.9-2.3.9-2.3s.2-1.9.2-3.7v-1.4c0-1.9-.2-3.8-.2-3.8z"/></svg>Watch this Short →</span>
      </a>
      <a class="stile" href="https://www.youtube.com/@fitcaresupportservices">
        <div class="media media--short"><img class="media-img" src="@/assets/img/yt/short-4.jpg" alt="FITCare Short: a smiling gym-goer at the cable machine — 'Slaying'"><span class="play-badge"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg></span></div>
        <span class="stile-cap"><svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M23 7.5s-.2-1.6-.9-2.3c-.9-.9-1.9-.9-2.4-1C16.4 4 12 4 12 4s-4.4 0-7.7.2c-.5.1-1.5.1-2.4 1-.7.7-.9 2.3-.9 2.3S1 9.4 1 11.3v1.4c0 1.9.2 3.8.2 3.8s.2 1.6.9 2.3c.9.9 2 .9 2.5 1 1.8.2 7.4.2 7.4.2s4.4 0 7.7-.3c.5-.1 1.5-.1 2.4-1 .7-.7.9-2.3.9-2.3s.2-1.9.2-3.7v-1.4c0-1.9-.2-3.8-.2-3.8z"/></svg>Watch this Short →</span>
      </a>
    </div>
...
<section class="section" id="activities">
  <div class="wrap">
    ...
    <div class="act-grid">
      <div class="act"><div class="media media--wide"><img class="media-img" src="@/assets/img/act-lawn-bowls.jpg" alt="A lawn bowler releases a bowl on a village green while teammates watch"></div><div class="act-body"><span class="chip">Social</span><h3>Lawn bowls &amp; lunch</h3><div class="act-when"><span>[Day &amp; time]</span></div><p>A friendly roll-up followed by lunch with the crew. All abilities welcome.</p></div></div>
      <div class="act"><div class="media media--wide"><img class="media-img" src="@/assets/img/act-pottery.jpg" alt="Hands shaping a small clay pot at a busy pottery class table"></div><div class="act-body"><span class="chip">Creative</span><h3>Pottery studio</h3><div class="act-when"><span>[Day &amp; time]</span></div><p>Get your hands dirty and make something worth keeping.</p></div></div>
      <div class="act"><div class="media media--wide"><img class="media-img" src="@/assets/img/act-group-fitness.jpg" alt="An outdoor group fitness class mid-move on a sunny park track"></div><div class="act-body"><span class="chip">Fitness</span><h3>Group fitness</h3><div class="act-when"><span>[Day &amp; time]</span></div><p>Move at your own pace with a team that cheers you on.</p></div></div>
    </div>
