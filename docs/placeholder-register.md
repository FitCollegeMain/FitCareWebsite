...
## 3b. Home social feed panel (added 3 Jul 2026; Instagram row removed same day by client decision)

| Item | Notes | Owner |
|---|---|---|
| ~~YouTube channel URL~~ **DELIVERED 3 Jul 2026** — `youtube.com/@fitcaresupportservices`; button wired. Developer still resolves the `UC…` channel ID for the RSS feed (one-time, spec in dev README §8b) | ✔ / D |
