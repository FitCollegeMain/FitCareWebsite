...
<section class="section" style="padding-bottom:clamp(32px,5vw,56px)">
  <div class="wrap">
    <div class="sec-head" style="margin-bottom:0;max-width:760px">
      ...
      <p>FITCare Support Services exists to empower people to get what they want out of life — by creating better access to all things. We're a registered NDIS provider on the Sunshine Coast, and we do it with the healthiest team in the business: over half our 60+ support workers hold fitness qualifications, alongside swim instructors, yoga teachers, football coaches and distance runners.</p>
    </div>
  </div>
</section>
