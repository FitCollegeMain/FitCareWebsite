...
<section class="social" id="social" aria-label="Latest from our channels">
  ...
  <div class="wrap">
    <div class="sec-head">
      ...
      <p>The latest from our YouTube channel and Instagram — real activities, real people, this week. <span class="chip chip--sample">Sample tiles — the live feeds pull the 4 newest videos + 4 newest posts automatically in production</span></p>
    </div>
    <div class="social-grid" data-feed="youtube-latest-4 instagram-latest-4">
      ...
      <a class="stile" href="https://www.instagram.com/fitcare.supportservices/">
        <div class="media media--square" role="img" aria-label="Placeholder for the most recent Instagram post"><div class="media-label"><strong>Instagram</strong>Newest post</div></div>
        <span class="stile-cap"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4.5"/><circle cx="17.2" cy="6.8" r="1.3" fill="currentColor" stroke="none"/></svg>@fitcare.supportservices</span>
      </a>
      <a class="stile" href="https://www.instagram.com/fitcare.supportservices/">
        <div class="media media--square" role="img" aria-label="Placeholder for the second most recent Instagram post"><div class="media-label"><strong>Instagram</strong>Post 2</div></div>
        <span class="stile-cap"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4.5"/><circle cx="17.2" cy="6.8" r="1.3" fill="currentColor" stroke="none"/></svg>@fitcare.supportservices</span>
      </a>
      <a class="stile" href="https://www.instagram.com/fitcare.supportservices/">
        <div class="media media--square" role="img" aria-label="Placeholder for the third most recent Instagram post"><div class="media-label"><strong>Instagram</strong>Post 3</div></div>
        <span class="stile-cap"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4.5"/><circle cx="17.2" cy="6.8" r="1.3" fill="currentColor" stroke="none"/></svg>@fitcare.supportservices</span>
      </a>
      <a class="stile" href="https://www.instagram.com/fitcare.supportservices/">
        <div class="media media--square" role="img" aria-label="Placeholder for the fourth most recent Instagram post"><div class="media-label"><strong>Instagram</strong>Post 4</div></div>
        <span class="stile-cap"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4.5"/><circle cx="17.2" cy="6.8" r="1.3" fill="currentColor" stroke="none"/></svg>@fitcare.supportservices</span>
      </a>
    </div>
    <div class="social-ctas">
      <a class="btn btn--light" href="https://www.instagram.com/fitcare.supportservices/">Follow @fitcare.supportservices</a>
      <a class="btn btn--outline-light" href="#social">Watch on YouTube <span class="chip chip--sample" style="margin-left:4px">channel link pending</span></a>
    </div>
  </div>
</section>
